...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .return-grid{display:grid;gap:8px}.return-line{display:grid;grid-template-columns:24px minmax(0,1fr) 90px;gap:8px;align-items:center;padding:9px;border:1px solid var(--line);border-radius:8px;background:#f8fafc}.return-line input[type=checkbox]{width:20px;min-height:20px}.inventory-row{grid-template-columns:1fr;gap:12px}.inventory-main{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;align-items:start}.inventory-stats{display:grid;grid-template-columns:88px 88px 110px 164px;gap:8px;align-items:end}.inventory-stat{display:grid;gap:3px;padding:8px 10px;border:1px solid var(--line);border-radius:8px;background:#f8fafc}.inventory-stat strong{font-size:22px}.stock-controls{display:grid;grid-template-columns:42px minmax(58px,1fr) 42px;gap:6px}.stock-controls button{width:42px;height:42px;background:#e2e8f0}.stock-controls input{text-align:center;font-weight:900;padding:4px}
    .category-manager{display:grid;gap:10px;margin-bottom:14px;padding:12px;border:1px solid var(--line);border-radius:10px;background:#f8fafc}.category-tools{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px}.inventory-form,.add-product-grid{display:grid;gap:8px;align-items:center}.inventory-form{grid-template-columns:150px 190px 58px 110px 58px 88px minmax(180px,1fr) 156px 120px}.add-product-grid{grid-template-columns:1.2fr 110px 1fr 110px 1fr auto}.field-label{font-size:15px;font-weight:900;color:#475569}.inventory-thumb{width:78px;height:78px;border-radius:8px;border:1px solid var(--line);background:#fff;object-fit:cover;cursor:zoom-in}.inventory-large-image{display:none;width:min(360px,100%);max-height:360px;object-fit:contain;border:1px solid var(--line);border-radius:10px;background:#fff}.inventory-row.previewing .inventory-large-image{display:block}.inventory-form input,.inventory-form select,.add-product-grid input,.add-product-grid select{min-height:44px;padding:6px 8px;font-size:16px}.inventory-form input[type=file]{padding:9px 8px;background:#fff}.image-modal-card{width:min(920px,100%);background:#0f172a;border-radius:12px;overflow:hidden}.image-modal-card .modal-head{background:#0f172a;color:#fff;border-bottom:1px solid rgba(255,255,255,.15)}.image-modal-card .close{background:#334155;color:#fff}.image-preview{display:block;max-width:100%;max-height:82vh;margin:0 auto;object-fit:contain;background:#0f172a}
