...
<body>
  ...
  <script>
    ...
    function allTypeOptions(){
      ...
      return [...new Set([...DEFAULT_TYPE_OPTIONS,...(state.categoryOptions||[]),...PRODUCTS.map(p=>productType(p))])].filter(c=>c && !hidden.includes(c)).sort((a,b)=>typeRank(a)-typeRank(b)||a.localeCompare(b,"zh-Hant"));
    }
