...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .category-manager{display:grid;gap:10px;margin-bottom:14px;padding:12px;border:1px solid var(--line);border-radius:10px;background:#f8fafc}.category-tools{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px}.category-editor,.product-editor,.add-product-grid{display:grid;grid-template-columns:120px minmax(140px,1fr) auto;gap:8px;align-items:center}.product-editor{grid-template-columns:96px minmax(110px,.6fr) 96px minmax(160px,1fr) minmax(120px,1fr) auto}.add-product-grid{grid-template-columns:1.2fr 110px 1fr 110px 1fr auto}.field-label{font-size:15px;font-weight:900;color:#475569}.inventory-thumb{width:78px;height:78px;border-radius:8px;border:1px solid var(--line);background:#fff;object-fit:cover;cursor:zoom-in}.category-editor select,.product-editor input,.add-product-grid input,.add-product-grid select{min-height:44px;padding:6px 8px;font-size:16px}.category-editor button,.product-editor button{min-height:44px;padding:0 10px;background:#e2e8f0}.product-editor input[type=file]{padding:9px 8px;background:#fff}.image-modal-card{width:min(920px,100%);background:#0f172a;border-radius:12px;overflow:hidden}.image-modal-card .modal-head{background:#0f172a;color:#fff;border-bottom:1px solid rgba(255,255,255,.15)}.image-modal-card .close{background:#334155;color:#fff}.image-preview{display:block;max-width:100%;max-height:82vh;margin:0 auto;object-fit:contain;background:#0f172a}
